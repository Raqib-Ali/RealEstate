...
const UpdateListing = () => {
    ...
    return (
        <div>
            <h1 className="text-center text-3xl font-bold my-6">Update Listing</h1>
            <form onSubmit={(e) => { handleSubmit(e) }} className="flex flex-col sm:flex-row max-w-4xl mx-auto gap-4 p-2">
                ...
                <div className="flex flex-col flex-1 gap-2">
                    ...
                    <div className='flex flex-col gap-2 max-h-60 overflow-auto'>
                        {formData?.imgUrls && formData?.imgUrls.map((image) => {
                            return <div key={image} className='flex justify-between p-2 border'>
                    ...
                    {success && <p className='text-sm text-green-600 mt-2'>Listing has been updated.</p>}
                </div>
            </form>
